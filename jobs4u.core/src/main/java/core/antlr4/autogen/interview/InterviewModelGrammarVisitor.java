...
public interface InterviewModelGrammarVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by {@link InterviewModelGrammarParser#questionsList}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitQuestionsList(InterviewModelGrammarParser.QuestionsListContext ctx);
