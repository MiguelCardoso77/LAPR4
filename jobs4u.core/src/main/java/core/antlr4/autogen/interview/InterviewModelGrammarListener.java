...
public interface InterviewModelGrammarListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link InterviewModelGrammarParser#questionsList}.
     *
     * @param ctx the parse tree
     */
    void enterQuestionsList(InterviewModelGrammarParser.QuestionsListContext ctx);

    /**
     * Exit a parse tree produced by {@link InterviewModelGrammarParser#questionsList}.
     *
     * @param ctx the parse tree
     */
    void exitQuestionsList(InterviewModelGrammarParser.QuestionsListContext ctx);
